...
namespace Position
{
    ...
    static BLHCoordinate delta(double lat, double lon)
    {
    ...
    //WGS-84 to GCJ-02
    BLHCoordinate transWgs84to02(double wgsLat, double wgsLon)
    {
    ...
    //GCJ-02 to WGS-84
    BLHCoordinate trans02toWgs84(double gcjLat, double gcjLon)
    {
