...
const int EDGE_THRESHOLD = 19;
    ...
    {
        int nfeatures = GETCFGVALUE(GETGLOBALCONFIG(),FeatureCnt    ,int);
        int nlevel    = GETCFGVALUE(GETGLOBALCONFIG(),PyramidLevel  ,int);
...
{
    // Compute how many initial nodes   like  cols / rows
