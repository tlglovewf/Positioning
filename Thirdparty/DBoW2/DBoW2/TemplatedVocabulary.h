...
public:
  ...
  /**
   * Loads the vocabulary from a stringstream
   * @param stringstream
   */
  bool loadFromTextStr(const char *textStr);
...
template<class TDescriptor, class F>
bool TemplatedVocabulary<TDescriptor,F>::loadFromTextStr(const char *textStr)
{
    stringstream f;
    f << textStr;
