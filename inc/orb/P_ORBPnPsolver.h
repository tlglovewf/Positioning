...
#ifndef _ORBPNPSOLVER_H_
#define _ORBPNPSOLVER_H_
...
namespace Position
{
    ...
    private:
      ...
      FloatVector mvSigma2;

      // 3D Points
      vector<cv::Point3f> mvP3Dw;

      // Index in Frame
      SzVector mvKeyPointIndices;
      ...
      FloatVector mvMaxError;

    };

} 

#endif //_ORBPNPSOLVER_H_
